(function () {
    ...
    function () {
        ...
        var a = this,
            ...
            f = function (a, b, c, d) {
                if (d) {
                    if (void 0 !== a.path && a.path.indexOf) return {
                        path: a.path,
    ...
    function () {
        ...
        var a = this,
            ...
            y = function (a, b, c, d) {
                this.params = b || {}, this.el = a, this.params.addClass(this.el, this._class), this.uuid = D();
                var e = !0;
            ...
            B = function (a, b, c, d) {
                ...
                var k = [0, 0],
                    ...
                    o = [0, 0],
                    q = !1,
                    r = !1 !== this.params.consumeStartEvent,
                    t = this.el,
                    v = this.params.clone,
                    B = (this.params.scroll, !1 !== b.multipleDrop),
                    C = !1,
                    F = !0 === b.ghostProxy ? z : b.ghostProxy && "function" == typeof b.ghostProxy ? b.ghostProxy : A,
                    G = function (a) {
                ...
                this.posses = [], this.posseRoles = {}, this.toGrid = function (a) {
                    ...
                    var b = this.params.grid ? this.params.grid[0] / 2 : H || i / 2,
                        c = this.params.grid ? this.params.grid[1] / 2 : H || j / 2;
                    ...
                    if (null != t) {
                        ...
                        this.params.setPosition(t, I(c, a, b, d, e))
                    }
                ...
                var N = function (a) {
                        return "function" == typeof a ? (a._katavorioId = D(), a._katavorioId) : a
                    },
                    O = {},
                    P = function (a) {
                        for (var b in O) {
                ...
                this.downListener = function (a) {
                    if ((this.rightButtonCanDrag || 3 !== a.which && 2 !== a.button) && this.isEnabled() && this.canDrag())
                        if (P(a) && x(a, this.el, this.k)) {
                            if (v)
                                if (t = this.el.cloneNode(!0), this.params.addClass(t, p.clonedDrag), t.setAttribute("id", null), t.style.position = "absolute", null != this.params.parent) {
                                    var b = this.params.getPosition(this.el);
                                    t.style.left = b[0] + "px", t.style.top = b[1] + "px", this.params.parent.appendChild(t)
                                } else {
                                    var d = f(this.el);
                                    t.style.left = d.left + "px", t.style.top = d.top + "px", document.body.appendChild(t)
                                }
                            else t = this.el;
                            r && w(a), k = m(a), this.params.bind(document, "mousemove", this.moveListener), this.params.bind(document, "mouseup", this.upListener), h.markSelection(this), h.markPosses(this), this.params.addClass(document.body, c.noSelect), V("beforeStart", {
                                el: this.el,
                                pos: l,
                                e: a,
                                drag: this
                    ...
                    if (k) {
                        ...
                        if (k) {
                            ...
                            c /= e, d /= e, this.moveBy(c, d, a), h.updateSelection(c, d, this), h.updatePosses(c, d, this)
                        }
                    }
                }.bind(this), this.upListener = function (a) {
                    k && (k = null, this.params.unbind(document, "mousemove", this.moveListener), this.params.unbind(document, "mouseup", this.upListener), this.params.removeClass(document.body, c.noSelect), this.unmark(a), h.unmarkSelection(this, a), h.unmarkPosses(this, a), this.stop(a), h.notifySelectionDragStop(this, a), h.notifyPosseDragStop(this, a), q = !1, v && (t && t.parentNode && t.parentNode.removeChild(t), t = null), T.length = 0, M && !0 === M(this.el, this.params.getPosition(this.el)) && (this.params.setPosition(this.el, l), V("revert", this.el)))
                ...
                var V = function (a, b) {
                    var c = null;
                    if (U[a])
                        for (var d = 0; d < U[a].length; d++) try {
                            var e = U[a][d](b);
                            null != e && (c = e)
                        } catch (a) {}
                    return c
                ...
                this.notifyStart = function (a) {
                    ...
                    l = this.params.getPosition(t), n = this.params.getPosition(t, !0), o = [n[0] - l[0], n[1] - l[1]], this.size = this.params.getSize(t), S = h.getMatchingDroppables(this), u(S, !0, !1, this), this.params.addClass(t, this.params.dragClass || c.drag);
                    var b;
                    b = this.params.getConstrainingRectangle ? this.params.getConstrainingRectangle(t) : this.params.getSize(t.parentNode), R = {
                        w: b[0],
                        h: b[1]
                ...
                this.unmark = function (a, d) {
                    if (u(S, !1, !0, this), C && F(this.el) ? (W = [t.offsetLeft, t.offsetTop], this.el.parentNode.removeChild(t), t = this.el) : W = null, this.params.removeClass(t, this.params.dragClass || c.drag), S.length = 0, C = !1, !d) {
                        T.length > 0 && W && b.setPosition(this.el, W), T.sort(E);
                        for (var e = 0; e < T.length; e++) {
                            if (!0 === T[e].drop(this, a)) break
                        }
                    }
                    ...
                    if (F(this.el))
                        if (e[0] !== f[0] || e[1] !== f[1]) {
                            if (!C) {
                                var g = G(this.el);
                                b.addClass(g, p.ghostProxy), this.el.parentNode.appendChild(g), t = g, C = !0
                            }
                            f = e
                        } else C && (this.el.parentNode.removeChild(t), t = this.el, C = !1);
                    var h = {
                            x: f[0],
                            y: f[1],
                            w: this.size[0],
                    ...
                    for (var k = 0; k < S.length; k++) {
                        ...
                        this.params.intersects(i, m) && (B || null == j || j === S[k].el) && S[k].canDrop(this) ? (j || (j = S[k].el), T.push(S[k]), S[k].setHover(this, !0, d)) : S[k].isHover() && S[k].setHover(this, !1, d)
                    }
                    V("drag", {
                        el: this.el,
                        pos: f,
            ...
            C = function (a, b, c, d) {
                this._class = c.droppable, this.params = b || {}, this.rank = b.rank || 0, this._activeClass = this.params.activeClass || c.active, this._hoverClass = this.params.hoverClass || c.hover, y.apply(this, arguments);
                var e = !1;
            ...
            F = function (a) {
                return null == a ? null : null == (a = "string" == typeof a || a.constructor === String ? document.getElementById(a) : a) ? null : (a._katavorio = a._katavorio || D(), a)
            };
        a.Katavorio = function (a) {
            ...
            var h = 1,
                ...
                k = (this.getMatchingDroppables = function (a) {
                    ...
                    for (c in a) d[c] = a[c];
                    for (c in b) d[c] = b[c];
                    for (c = 0; c < q.length; c++) d.events[q[c]] = b[q[c]] || r;
            ...
            for (var s in n) m[s] = n[s];
            var u = a.inputFilterSelector || "input,textarea,select,button,option";
            this.getInputFilterSelector = function () {
                ...
                return v(b, function (b) {
                    if (null != (b = F(b)))
                        if (null == b._katavorioDrag) {
                            var e = k(c);
                            b._katavorioDrag = new B(b, e, m, o), i(b._katavorioDrag, this._dragsByScope), d.push(b._katavorioDrag), a.addClass(b, m.draggable)
                ...
                a.posses && v(a.posses, function (b) {
                    a.posseRoles[b] && A[b] && t(A[b].members, function (a) {
                        a.mark()
                    }, a)
                })
                ...
                a.posses && v(a.posses, function (c) {
                    a.posseRoles[c] && A[c] && t(A[c].members, function (a) {
                        a.unmark(b, !0)
                    }, a)
                })
            ...
            var w = function (a, b) {
                b.posses && v(b.posses, function (c) {
                    b.posseRoles[c] && A[c] && t(A[c].members, function (b) {
                        a(b)
                    }, b)
                })
            };
            ...
            v(["set", "add", "remove", "toggle"], function (a) {
                this[a + "Scope"] = function (b, c) {
                    ...
                    x(b.constructor === B ? b : b._katavorioDrag, c, this._dragsByScope, a + "Scope")
                }.bind(this), this[a + "DropScope"] = function (b, c) {
                    x(b.constructor === C ? b : b._katavorioDrop, c, this._dropsByScope, a + "Scope")
                }.bind(this)
            ...
            var y = function (a, b, c) {
                    if (a = F(a), a[b]) {
                        var d = f.indexOf(a[b]);
                        d >= 0 && f.splice(d, 1), j(a[b], c) && v(a[b], function (a) {
                            a.destroy()
                        }), delete a[b]
                    }
                },
                z = function (a, b, c, d) {
                    a = F(a), a[b] && a[b].off(c, d)
                };
            ...
            this.addToPosse = function (a, b) {
                ...
                for (var d = 1; d < arguments.length; d++) b = arguments[d], v(a, function (a) {
    ...
    function () {
        ...
        function l(b, e, g) {
            ...
            for (i in e)
                if (null == l[i]) l[i] = e[i];
                else if (c(e[i]) || d(e[i])) j[i] ? (h = [], h.push.apply(h, a(l[i]) ? l[i] : [l[i]]), h.push.apply(h, d(e[i]) ? e[i] : [e[i]]), l[i] = h) : l[i] = e[i];
    ...
    function () {
        ...
        var m = 0,
            ...
            o = a.jsPlumbInstance = function (d) {
                this.version = "2.7.5", d && p.extend(this.Defaults, d), this.logEnabled = this.Defaults.LogEnabled, this._connectionTypes = {}, this._endpointTypes = {}, b.EventGenerator.apply(this);
                var f = this,
                    g = n(),
                    h = f.bind,
                    j = {},
                    ...
                    L = function (a, c, d, e, g) {
                        if (!p.headless) {
                            if (null != c && c && p.isDragSupported(a, f)) {
                                ...
                                if (h = p.extend({}, h), p.isAlreadyDraggable(a, f)) d.force && f.initDraggable(a, h);
                                else {
                                    ...
                                    qa(e, a), h[k] = b.wrap(h[k], function () {
                                        if (f.setHoverSuspended(!0), f.select({
                                                source: a
                                            }).addClass(f.elementDraggingClass + " " + f.sourceElementDraggingClass, !0), f.select({
                                                target: a
                                            }).addClass(f.elementDraggingClass + " " + f.targetElementDraggingClass, !0), f.setConnectionBeingDragged(!0), h.canDrag) return d.canDrag()
                                        ...
                                        for (var a, b = arguments[0].selection, c = function (b) {
                                                null != b[1] && (a = f.getUIPosition([{
                                                    ...
                                                    target: b[2].el
                                                }).removeClass(f.elementDraggingClass + " " + f.targetElementDraggingClass, !0), f.getDragManager().dragEnded(b[2].el)
                ...
                this.setSource = function (a, b, c) {
                    ...
                    for (var b in v) {
                        var c = v[b];
                        if (c && c.length)
                            for (var d = 0, e = c.length; d < e; d++) f.deleteEndpoint(c[d], !0)
                    }
                ...
                this.deleteConnection = function (a, c) {
                    ...
                    ])) || (a.setHover(!1), _(a, !a.pending && !1 !== c.fireEvent, c.originalEvent), a.endpoints[0].detachFromConnection(a), a.endpoints[1].detachFromConnection(a), b.removeWithFunction(u, function (b) {
                        return a.id === b.id
                    ...
                    var c = Y(a),
                        d = v[c];
                    if (d && d.length)
                        for (var e = 0, g = d.length; e < g; e++) d[e].deleteEveryConnection(b);
                    return f
                ...
                var ca = function (a, b, c, d) {
                    ...
                    ga = function (a, b) {
                        ...
                        if (a)
                            ...
                            for (var d = 0, e = a.length; d < e; d++) c.push(m(a[d]).id);
                        else c.push(m(a).id);
                        return c
                    },
                    ha = function (a, b, c) {
                ...
                this.init = function () {
                    t || (pa(), f.anchorManager = new a.jsPlumb.AnchorManager({
                        jsPlumbInstance: f
                    }), t = !0, f.fire("ready", f))
                    ...
                    if ("string" == typeof e) h = d(arguments[0], {
                        ...
                        if (b.isArray(e[0]) || b.isString(e[0])) 2 === e.length && b.isObject(e[1]) ? b.isString(e[0]) ? (c = a.jsPlumb.extend({
                            elementId: g,
                            jsPlumbInstance: f
                ...
                this.repaint = function (a, b, c) {
                    ...
                    var d = function (a) {
                        var e, g, h = m(a),
                            i = v[h.id];
                        if (i)
                            for (c.push(h), e = 0, g = i.length; e < g; e++) f.deleteEndpoint(i[e], !1);
                        if (delete v[h.id], b && h.el && 3 !== h.el.nodeType && 8 !== h.el.nodeType)
                            for (e = 0, g = h.el.childNodes.length; e < g; e++) d(h.el.childNodes[e])
                    };
                    return d(a), this
                };
                var za = function (a, b) {
    ...
    function () {
        ...
        var B = function (a, c) {
            a.apply(this, c),
                b.jsPlumbUIComponent.apply(this, c), this.isAppendedAtTopLevel = !1;
            ...
            update: function (a, b) {
                ...
                if (null != g && null != a._rotors) {
                    ...
                    for (var j = 0; j < f.length; j++)
                        for (var k = f[j], l = 0; l < k[1].length; l++) try {
                            k[1][l](k[0], k[2])
                        } catch (a) {}
                }
            },
    ...
    function () {
        ...
        b.Connection.prototype.animateOverlay = function (a, f) {
            ...
            var j, k, l, m = c.uuid(),
                ...
                y = n ? g.source : g.target,
                z = n ? g.target : g.source;
            ...
            var B = function () {
                ...
                E = function () {
                    h.fire(d.nodeTraverseStart, {
                        ...
                        b.removeClass(y, e.nodeTraversing), h.fire(d.nodeTraverseEnd, {
                            connection: g,
                            element: y
                        }), D()
                    }, p)
        ...
        b.Selection = function (a) {
            ...
            var s = function (a, b) {
                ...
                v = function (a, b, d) {
                    ...
                    var i = function (a) {
                        var j;
                        if (c.isString(a)) null != (j = e.getNode(a) || e.getEdge(a) || e.getGroup(a)) && (f = b(j, d), g.push.apply(g, f[0]), h.push.apply(h, f[1]));
            ...
            j = b.Group = function (a, b, c) {
                ...
                this.addVertex = this.addNode = function (a) {
                    ...
                    if (a = "string" == typeof a ? e[a] : a) {
                        var b = d.indexOf(a); - 1 != b && (d.splice(b, 1), delete e[a.id]), delete a.group
                    }
    ...
    function () {
        ...
        a.jsPlumbToolkitInstance = function (i) {
            ...
            var j = i.idFunction || h,
                ...
                B = i.portFactory || y,
                C = i.groupFactory || y,
                D = i.autoSave && i.saveUrl,
                E = i.saveUrl,
                F = i.saveHeaders,
                G = i.onAutoSaveSuccess || function () {},
                H = i.onAutoSaveError || function () {},
                I = !0 === i.doNotUpdateOriginalData,
                J = i.onBeforeAutoSave || function () {},
            ...
            this.beforeConnect = i.beforeConnect || Q, this.beforeMoveConnection = i.beforeMoveConnection || Q, this.beforeStartConnect = i.beforeStartConnect || function (a, b) {
                ...
                var b;
                if (!v) {
                    var d = N.getVertex(a.source),
                        e = N.getVertex(a.target),
                        f = a.cost,
                        g = a.directed;
                    if (!d) {
                        if (a.doNotCreateMissingNodes) return;
                        d = N.addVertex(a.source), u.fire("nodeAdded", {
                            data: {},
                            node: d
                        })
                    }
                    if (!e) {
                        if (a.doNotCreateMissingNodes) return;
                        e = N.addVertex(a.target), u.fire("nodeAdded", {
                            data: {},
                            node: e
                        })
                    }
                    ...
                    if (h) {
                        ...
                        !1 !== this.beforeConnect(d, e, i) && (b = N.addEdge({
                            source: d,
                            target: e,
                            cost: f,
                            directed: g,
                ...
                var f = N.addGroup(b, j);
                return X || I || a.jsPlumbToolkitIO.manage("addGroup", V, W, f, j || N.getIdFunction(), u), e || u.fire("groupAdded", {
                    data: b,
                    group: f,
                    eventInfo: c
                }), f
                ...
                var c = !1;
                return a = u.getNode(a), b = u.getGroup(b), a && b && (c = b.addVertex(a)) && (a.data.group = b.id, u.fire("group:addMember", {
                    node: a,
                ...
                return e && (X || I || a.jsPlumbToolkitIO.manage("removeGroup", V, W, e, j || N.getIdFunction(), u), d || u.fire("groupRemoved", {
                    group: e,
                    removeChildNodes: c
                })), u
                ...
                for (var b = 0; b < arguments.length; b++)
                    if (null == N.getVertex(arguments[b])) return !1;
                return !0
                ...
                return !1 === d.success || c || u.fire("edgeTarget", d), d
            }, this.setSource = function (a, b, c) {
                var d = N.setSource.apply(N, arguments);
                return !1 === d.success || c || u.fire("edgeSource", d), d
                ...
                b = N.getVertex(b), B({
                    ...
                    f.data = c, S(b), X || I || a.jsPlumbToolkitIO.manage("addPort", V, W, {
                        node: b,
                        port: f
                    }, q || N.getIdFunction(), u), e || u.fire("portAdded", {
                        node: b,
                        data: c,
                        port: f
                    }, null)
                ...
                return S(b), X || I || a.jsPlumbToolkitIO.manage("addPort", V, W, {
                    node: b,
                    port: e
                }, q || N.getIdFunction(), u), d || u.fire("portAdded", {
                    node: b,
                    data: c,
                    port: e
                }, null), e
            ...
            this.updateNode = function (a, b) {
                ...
                if (e) {
                    ...
                    if (d)
                        for (var g in d) null == e.data[g] ? e.data[g] = d[g] : b.replace(e.data, g, d[g]);
                    u.fire("edgeUpdated", {
                        edge: e,
                        updates: d || {},
                        originalData: f
            ...
            var ba = function (a, b) {
                for (var c = 0; c < b.length; c++) u.fire(a, {
                    obj: b[c],
                    selection: $
                })
            };
            ...
            if (this.render = function (e, f) {
                    ...
                    var h = g.type || a.jsPlumbToolkit.DefaultRendererType,
                        ...
                        j = g.id || b.uuid();
                    return da[j] = i, i.id = j, i._onDestroy = function (a) {
                        delete da[a.id]
                    }, i
        ...
        c.AbstractLayout = function (b) {
            function c() {
                var a, c, d, e, f = function (a) {
                    ...
                    g = function (a, c) {
                        return (b.locationFunction || f)(a, c)
                    },
                    h = o.getGroupCount();
                for (c = 0; c < h; c++)
            ...
            var d = this,
                ...
                m = !1 !== b.magnetized && (d.defaultMagnetized || !0 === b.magnetize);
            ...
            var P = this.getPositions = function () {
                ...
                R = this.getExtents = function () {
                    return [r, s, t, u]
                },
                S = (this.getSize = function (a) {
                    return x[a]
        ...
        var h = c.AbstractHierarchicalLayout = function (a) {
            ...
            return b.begin = function (b, c) {
                c.ignoreLoops = !(!1 === a.ignoreLoops), c.getRootNode = c.getRootNode || function (b) {
                    return !1 !== a.multipleRoots ? b.filter(function (a) {
                    ...
                    return d.toolkit.getAllEdgesFor(b, function (c) {
                        return c.source === b || !0 !== a.ignorePorts && c.source.getNode && c.source.getNode() === b
                    })
    ...
    function () {
        ...
        c.Circular = function (a) {
            ...
            var e = c.AbstractLayout.apply(this, arguments),
                f = !!a.parameters && !0 === a.parameters.centerRootNode;
    ...
    function () {
        ...
        c.Balloon = function (a) {
            a = a || {};
            var b, e = c.AbstractHierarchicalLayout.apply(this, arguments),
                f = [];
            this.defaultParameters = {
                padding: 50,
                locationFunction: a.locationFunction,
            ...
            var i = function (a, c, g) {
                ...
                var v = b(a);
                for (h = 0; h < v.length; h++) p.childMap[v[h].target.id] || (p.childMap[v[h].target.id] = !0, p.children.push(v[h].target));
                if (l = u(p.focus.id), k = Math.max(l[0], l[1]), n = o(r - l[0] / 2, s - l[1] / 2, l[0], l[1]), e.setPosition(p.focus.id, -l[0] / 2, -l[1] / 2, !0), p.children.length > 0) {
                    f.push(p);
                    var w = 2 * Math.PI / (p.children.length + (c ? 1 : 0)),
                        x = c ? c.incidentAngle + Math.PI + w : Math.PI,
                        y = x;
                    for (h = 0; h < p.children.length; h++) {
                        j = p.children[h], m = u(j.id);
                        var z = o(r + Math.sin(x) * m[0], s + Math.cos(x) * m[1], m[0], m[1]);
                        if (I = d.calculateSpacingAdjustment(n, z), L = Math.sqrt(Math.pow(z.x + I.left - r, 2) + Math.pow(z.y + I.top - s, 2)), k = Math.max(k, L), p.setPosition(j.id, z.x + I.left, z.y + I.top), x += w, h > 0) {
                            var A = p.children[h - 1],
                                B = u(A.id),
                                C = p.getPosition(A.id),
                                D = o(C[0], C[1], B[0], B[1]),
                                E = p.children[h],
                                F = u(E.id),
                                G = p.getPosition(E.id),
                                H = o(G[0], G[1], F[0], F[1]),
                                I = d.calculateSpacingAdjustment(D, H),
                                J = [C[0] + B[0] / 2, C[1] + B[1] / 2],
                                K = [G[0] + I.left + F[0] / 2, G[1] + I.top + +F[1] / 2],
                                L = Math.sqrt(Math.pow(J[0] - K[0], 2) + Math.pow(J[1] - K[1], 2));
                            k = Math.max(k, L / 2 / Math.sin(w / 2))
                        }
                    }
                    for (x = y, h = 0; h < p.children.length; h++) j = p.children[h], p.setIncidentAngle(j.id, x), p.setPosition(j.id, r + Math.sin(x) * k, s + Math.cos(x) * k, !0), x += w;
                    var M, N = p.positions[a.id][0],
                        O = e.getSize(a.id),
                        P = N + O[0],
                        Q = p.positions[a.id][1],
                        R = Q + O[1];
                    for (h = 0; h < p.children.length; h++) {
                        j = p.children[h];
                        i(j, {
                        ...
                        }, g) || (M = e.getSize(j.id), p.group.push(j), N = Math.min(N, p.positions[j.id][0]), P = Math.max(P, p.positions[j.id][0] + M[0]), Q = Math.min(Q, p.positions[j.id][1]), R = Math.max(R, p.positions[j.id][1] + M[1]))
                    }
                    for (p.extents = [N, P, Q, R], p.offsets = {}, h = 0; h < p.group.length; h++) {
                        var S = p.group[h];
                        p.offsets[S.id] = {
                            left: p.positions[S.id][0] - p.extents[0],
                            top: p.positions[S.id][1] - p.extents[2]
                        }
                    }
                }
            ...
            n = b.AbstractRenderer = function (a) {
                ...
                function n(a, b, c) {
                    if (null == a.value("jtk-processed")) {
                        ...
                        e.graph = {
                            node: b,
                            port: f
                        }, B.onUpdate(a.element, function () {})
                    }
                }

                function o(a, b) {
                    if (b.events)
                        for (var c in b.events) R.on(a, c, b.events[c])
                }
                ...
                function p(a, b, c) {
                    if (null == a.value("jtk-processed")) {
                        a.setValue("jtk-processed", !0);
                        var d = Ja(a, b, c);
                        null != d.portId && (_[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = D.addPort(b, {
                            id: d.portId,
                        ...
                        if ("true" === a.value("is-source") && (d.isSource = !0), delete d.uniqueEndpoint, delete d.createEndpoint, d.extract = {}, a.findDataValues(d.extract), "true" === a.value("endpoint")) {
                            ...
                            var i = R.addEndpoint(a.element, d);
                            i.graph = {
                                node: b
                            }, Ha[b.id] = i, B.onUpdate(a.element, function () {})
                        } else {
                            var j, k = a.element._katavorioDrop ? a.element._katavorioDrop.length : 0;
                            R.makeSource(a.element, d);
                            (a.element._katavorioDrop ? a.element._katavorioDrop.length : 0) > k && (j = a.element._katavorioDrop[a.element._katavorioDrop.length - 1]), B.onUpdate(a.element, function (a, c) {
                                var d = f.getSelector(a, "jtk-source");
                                if (1 === d.length) {
                                    var e = Ja(d[0], b);
                                    e.scope && (R.setSourceScope(a, e.scope, e.edgeType), j && j.k.setDropScope(j, e.scope))
                                }
                            })
                        }
                    }
                ...
                function q(a, b, c) {
                    if (null == a.value("jtk-processed")) {
                        a.setValue("jtk-processed", !0);
                        var d = Ja(a, b, c);
                        if (null != d.portId && (_[b.id + "." + d.portId] = a.element, a.element.jtk = a.element.jtk || {}, a.element.jtk.port = D.addPort(b, {
                                id: d.portId,
                                type: d.portType || "default"
                            }, !0), o(a.element, d)), "true" === a.value("is-target") && (d.isTarget = !0), delete d.uniqueEndpoint, delete d.createEndpoint, "true" === a.value("endpoint")) {
                            d.maxConnections = -1, d.isTarget = !0;
                            var e = R.addEndpoint(a.element, d);
                            e.graph = {
                                node: b
                            }, Ia[b.id] = e, B.onUpdate(a.element, function () {})
                        } else {
                            R.makeTarget(a.element, d);
                            var g = a.element._katavorioDrop[a.element._katavorioDrop.length - 1];
                            B.onUpdate(a.element, function (a, c) {
                ...
                function t(a, b, c) {
                    var d = ga(a);
                    if (d) {
                        (!b || r(d)) && (d.setVisible(b), c || (s(d, d.endpoints[0], b), s(d, d.endpoints[1], b)))
                    }
                }

                function u(a, b) {
                    var c;
                    if (a.eachNode && a.eachEdge) c = {
                        nodes: [],
                        edges: []
                        ...
                        c = [];
                        for (var d = 0; d < a.length; d++) c.push(b(v(a[d])))
                    } else c = b(v(a));
                    return c
                }

                function v(a) {
                    return a instanceof R.getDefaultConnectionType() && (a = a.edge), D.getObjectInfo(a, function (a) {
                        return a.getNode ? _[a.getFullId()] || Z[a.getNode().id] : Z[a.id] || aa[a.id]
                    })
                }
                a = a || {};
                var w = function (a, b) {
                    ...
                    x = '<div data-jtk-node-id="${id}" class="' + j.NODE + '"></div>',
                    y = {
                        rotors: {
                            render: function (a, b) {
                                return B.template(a, b).childNodes[0]
                            }
                        }
                    },
                    z = "rotors",
                    ...
                    C = this,
                    D = a.toolkit,
                    E = new c.Layouts.EmptyLayout(C),
                    F = f.getElement(a.container),
                    G = !(!1 === a.elementsDraggable),
                    H = !0 === a.elementsDroppable,
                    I = !1,
                    J = !1 !== a.refreshAutomatically,
                    K = a.templateRenderer ? e.isString(a.templateRenderer) ? y[a.templateRenderer] : {
                        render: a.templateRenderer
                    } : y[z],
                    L = !1 !== a.enhancedView,
                    M = a.assignPosse || function () {
                        return null
                    },
                    N = a.modelLeftAttribute || "left",
                    O = a.modelTopAttribute || "top",
                    P = !1 !== a.storePositionsInModel,
                    Q = e.merge(a.jsPlumb || {}),
                    R = a.jsPlumbInstance || f.getInstance(Q, a.overrideFns),
                    S = R.getId(F);
                R.bind("beforeDrop", function (a) {
                        var b = a.connection,
                            ...
                            g = a.connection.edge;
                        return null == g ? D.beforeConnect(e, f, a.connection.getData()) : D.beforeMoveConnection(e, f, g)
                    }), R.bind("beforeDrag", function (a) {
                        var b = a.endpoint.graph || a.source.jtk,
                            c = b.port || b.node,
                            d = a.endpoint.connectionType,
                            e = D.beforeStartConnect(c, d);
                        if (A) {
                            var f = xa.getEdgeDefinition(d) || {};
                            ...
                            var g = xa["get" + c.objectType + "Definition"](c.getType()) || {};
                            console.log(g), console.log("Toolkit response to drag start :"), console.log(e), console.log("---------------------------\n")
                        }
                        return !1 === e && a.endpoint.isTemporarySource && a.endpoint._deleteOnDetach && R.deleteEndpoint(a.endpoint), e
                    }), R.bind("beforeDetach", function (a, b) {
                        var c = a.endpoints[0].graph || a.source.jtk,
                            d = a.endpoints[1].graph || a.target.jtk,
                            e = c.port || c.node,
                            f = d.port || d.node,
                            g = a.edge;
                        return D.beforeDetach(e, f, g, b)
                    }),
                    R.bind("beforeStartDetach", function (a) {
                        var b = a.endpoint.graph || a.source.jtk,
                            c = b.port || b.node,
                            d = a.connection.edge;
                        return D.beforeStartDetach(c, d)
                    }), R.bind("connectionEdit", function (a) {
                        a.edge && (a.edge.geometry = a.getConnector().getGeometry())
                    }), e.EventGenerator.apply(this, arguments), a.activeFiltering && new c.UI.ActiveDragFilter(C, R, D), this.setDebug = function (a) {
                ...
                var T = [l.canvasClick, l.canvasDblClick, l.nodeAdded, l.nodeDropped, l.nodeRemoved, l.nodeRendered, l.groupAdded, l.groupRemoved, l.groupMoveEnd, l.groupMemberAdded, l.groupMemberRemoved, l.groupCollapse, l.groupExpand, l.nodeMoveStart, l.nodeMoveEnd, l.portAdded, l.portRemoved, l.edgeAdded, l.edgeRemoved, l.edgeTypeChanged, l.nodeTypeChanged, l.portTypeChanged, l.dataLoadEnd, l.anchorChanged, l.objectRepainted, l.modeChanged, l.lassoEnd, l.pan, l.zoom, l.relayout, l.click, l.tap, l.stateRestored, l.startOverlayAnimation, l.endOverlayAnimation, l.nodeVisibility],
                    U = C.bind,
                    V = R.bind;
                if (this.setHoverSuspended = R.setHoverSuspended, this.isHoverSuspended = R.isHoverSuspended, this.setJsPlumbDefaults = function (a) {
                        delete a.Container, R.restoreDefaults(), R.importDefaults(a)
                    }, this.bind = function (a, b) {
                        -1 == T.indexOf(a) ? V(a, b) : U(a, b)
                    }, a.events)
                    for (var W in a.events) this.bind(W, a.events[W]);
                if (a.interceptors)
                    for (var X in a.interceptors) this.bind(X, a.interceptors[X]);
                var Y = !1;
                V(l.connection, function (a) {
                    if (null == a.connection.edge) {
                        a.sourceEndpoint.getParameter("nodeId") || a.sourceEndpoint.setParameter("nodeId", $[a.sourceEndpoint.elementId].id), a.targetEndpoint.getParameter("nodeId") || a.targetEndpoint.setParameter("nodeId", $[a.targetEndpoint.elementId].id);
                        var b = a.sourceEndpoint.getParameter("portType"),
                            c = xa.getPortDefinition(b),
                        ...
                        !1 === D.getEdgeFactory()(d, a.connection.getData() || {}, function (b) {
                            k.edge = D.addEdge({
                                source: i,
                                target: j,
                                ...
                                data: b,
                                addedByMouse: !0
                            }, C), fa[k.edge.getId()] = a.connection, a.connection.edge = k.edge, ja(d, k.edge, a.connection), k.addedByMouse = !0, k.connection = a.connection, C.fire(l.edgeAdded, k)
                        }) && R.deleteConnection(a.connection)
                    }
                }), V(l.connectionMoved, function (a) {
                    var c = 0 === a.index ? a.newSourceEndpoint : a.newTargetEndpoint,
                        d = c.graph || c.element.jtk;
                    b(function () {
                        D.edgeMoved(a.connection.edge, d.port || d.node || d.group, a.index)
                    })
                }), V(l.connectionDetached, function (a) {
                    b(function () {
                        D.removeEdge(a.connection.edge)
                    });
                ...
                }), V(l.groupDragStop, function (a) {
                    C.getLayout().setPosition(a.group.id, a.pos[0], a.pos[1], !0), a.uigroup = a.group, C.fire(l.groupMoveEnd, f.extend(a, {
                        group: D.getGroup(a.uigroup.id)
                    }))
                }), V(l.groupMemberAdded, function (a) {
                    if (!I && a.el.jtk.node) {
                        var b = D.addToGroup(a.el.jtk.node, a.group.id);
                        b && C.fire(l.groupMemberAdded, {
                            node: a.el.jtk.node,
                            group: b,
                            uigroup: a.group
                        }), sa()
                    }
                }), V(l.groupMemberRemoved, function (a) {
                    if (!I && a.el.jtk.node) {
                        var b = D.removeFromGroup(a.el.jtk.node);
                        b && (C.nodeRemovedFromGroup(a.el), C.fire(l.groupMemberRemoved, {
                            node: a.el.jtk.node,
                            ugroup: b,
                            igroup: a.group
                        })), sa()
                    }
                }), V(l.groupCollapse, function (a) {
                    var b = D.getGroup(a.group.id);
                    b && C.fire(l.groupCollapse, {
                        group: b,
                        uigroup: a.group
                    })
                }), V(l.groupExpand, function (a) {
                    var b = D.getGroup(a.group.id);
                    b && C.fire(l.groupExpand, {
                        group: b,
                        uigroup: a.group
                    })
                });
                var Z = {},
                    ...
                    da = [],
                    ea = function (a) {
                        var b = da.indexOf(a); - 1 !== b && da.splice(b, 1)
                    };
                this.getNodeCount = function () {
                    return da.length
                }, this.getNodeAt = function (a) {
                ...
                var fa = {},
                    ...
                    ha = function (a) {
                        for (var b = [], c = 0; c < a.length; c++) b.push(fa[a[c].getId()]);
                        return b
                    },
                    ia = function (a, b, c, d) {
                    ...
                    ja = function (a, b, c) {
                        if (!c.getParameter("edge")) {
                            var d = xa.getEdgeDefinition(a);
                            if (d && d.events)
                                for (var e in d.events) ia(e, d.events[e], b, c)
                        }
                    },
                    ka = function (a) {
                        C.fire(l.edgeRemoved, {
                ...
                this.setSuspendRendering = function (a, b) {
                    I = a, R.setSuspendDrawing(a), b && this.refresh()
                }, this.batch = function (a) {
                    this.setSuspendEvents(!0), D.batch(a), this.setSuspendEvents(!1)
                };
                var la = function (a, b) {
                        if (I) oa.push([a, b]);
                        else {
                            ...
                            if (null != c) {
                                ...
                                d.unshift(a), R.addToPosse.apply(R, d)
                            }
                        }
                    },
                    ma = function () {
                        for (var a = 0; a < oa.length; a++) la.apply(this, oa[a])
                    },
                    na = [],
                    oa = [];
                if (!1 !== this.bindToolkitEvents) {
                    var pa = function () {
                        oa.length = 0, R.setSuspendDrawing(!0), this.setSuspendRendering(!0)
                    }.bind(this);
                    m(l.dataLoadStart, pa), m(l.dataAppendStart, pa), m(l.dataLoadEnd, function () {
                        this.setSuspendRendering(!1), ma(), R.getGroupManager().refreshAllGroups(), va(), C.relayout(), R.setSuspendDrawing(!1, !0), E && C.fire(l.dataLoadEnd)
                    }.bind(this)), m(l.dataAppendEnd, function () {
                        this.setSuspendRendering(!1), ma(), C.refresh(), R.setSuspendDrawing(!1, !0), E && C.fire(l.dataAppendEnd)
                    }.bind(this));
                    var qa = function (a, b, c) {
                            var d = aa[c.id];
                            if (d) {
                                (d.querySelector("[jtk-group-content]") || d).appendChild(a), R.addToGroup(c.id, a, !0), C.nodeAppendedToGroup(a, d, c)
                            }
                        },
                        ra = function (a, b) {
                            var c = Z[a.id];
                            if (null == c) {
                                if (!0 === xa.getNodeDefinition(D.getNodeType(a.data)).ignore) return !1;
                                if (!(c = Ca(a, a.data, a))) throw new Error("Cannot render node");
                                var d = R.getId(c);
                                Z[a.id] = c, $[d] = a, da.push(a), c.jtk = {
                                    node: a
                                }, null == a.group ? C.append(c, d, b ? b.position : null) : qa(c, a, a.group), la(c, a), Ma(c, a);
                                var e = {
                                    node: a,
                                    el: c,
                                    id: a.id
                                };
                                C.getLayout().nodeAdded(e, b), C.fire(l.nodeAdded, e)
                            }
                            return c
                        };
                    m(l.nodeAdded, function (a) {
                        var b, c = a.node,
                            d = ra(c, a.eventInfo);
                        if (null != d) {
                            var e = R.getSelector(d, "[data-port-id]");
                            for (b = 0; b < e.length; b++) {
                                var f = e[b].getAttribute("data-port-id");
                                _[c.id + "." + f] = e[b], e[b].jtk = e[b].jtk || {
                                    node: c,
                                    port: c.getPort(f)
                                }
                            }
                        ...
                        C.getLayout().nodeRemoved(a.nodeId);
                        var b = Z[a.nodeId];
                        C.fire(l.nodeRemoved, {
                            node: a.nodeId,
                            el: b
                        });
                        var c = R.getId(b);
                        B.remove(b), R.remove(b), delete Z[a.nodeId], delete Ha[a.nodeId], delete Ia[a.nodeId], delete $[c], ea(a.node), delete b.jtk, C.refresh(!0)
                    });
                    var sa = function () {
                        a.relayoutOnGroupUpdate && C.relayout()
                    };
                    m(l.groupMemberAdded, sa), m(l.groupMemberRemoved, sa);
                    var ta = function (b, c) {
                        var d = aa[b.id];
                        if (null == d) {
                            var g = xa.getGroupDefinition(D.getNodeType(b.data));
                            if (!0 === g.ignore) return !1;
                            if (!(d = Ea(b, b.data, b))) throw new Error("Cannot render Group");
                            var h = R.getId(d);
                            aa[b.id] = d, ba.push(b), ca[h] = b, d.jtk = {
                                group: b
                            }, C.append(d, h, c ? c.position : null), la(d, b), Ma(d, b);
                            var i = {
                                    node: b,
                                    el: d
                                },
                            ...
                            f.extend(j, {
                                ...
                                a.el.jtk && a.el.jtk.group && (j.dragOptions.magnetize ? a.pos = C.getLayout().setMagnetizedPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0) : C.getLayout().setPosition(a.el.jtk.group.id, a.pos[0], a.pos[1], !0), !1 !== P && (C.storePositionInModel({
                                    id: a.el.jtk.group.id,
                                    group: !0,
                                    leftAttribute: N,
                                    topAttribute: O
                                }), D.fire(l.groupUpdated, {
                                    group: a.el.jtk.group
                                }, null)), C.fire(l.groupMoveEnd, {
                                    el: a.el,
                                    group: a.el.jtk.group,
                                    pos: a.pos,
                                    e: a.e,
                            ...
                            }), R.addGroup(f.extend(j, g)), C.getLayout().groupAdded({
                                group: b,
                                el: d,
                                id: b.id
                            }, c), C.fire(l.groupAdded, i)
                        }
                        return d
                    };
                    m(l.groupAdded, function (a) {
                        var b = a.group;
                        null != ta(b, a.eventInfo) && C.refresh(!0)
                    }), m(l.groupRemoved, function (a) {
                        var b = a.group;
                        C.getLayout().groupRemoved(b.id);
                        var c = aa[b.id],
                            d = R.getId(c);
                        R.removeGroup(b.id, a.removeChildNodes, !0, !1), delete aa[b.id], delete ca[d], delete c.jtk, C.refresh(!0)
                    }), this.expandGroup = function (a) {
                        R.expandGroup("string" == typeof a ? a : a.id)
                    }, this.collapseGroup = function (a) {
                        R.collapseGroup("string" == typeof a ? a : a.id)
                    }, this.toggleGroup = function (a) {
                        R.toggleGroup("string" == typeof a ? a : a.id)
                    };
                    var ua = function (a, b) {
                            for (var c, d, e = a.getNodes(), f = 0, g = 0, h = C.getLayout(), i = R.getGroup(a.id), j = i.getDragArea(), k = b.autoSizePadding || [10, 10], l = 0; l < e.length; l++) c = h.getPosition(e[l].id), isNaN(c[0]) || isNaN(c[1]) || (d = h.getSize(e[l].id), f = Math.max(f, c[0] + d[0] + k[0]), g = Math.max(g, c[1] + d[1] + k[1]));
                            f = b.maxSize ? Math.min(b.maxSize[0], f) : f, g = b.maxSize ? Math.min(b.maxSize[1], g) : g, j.style.width = f + "px", j.style.height = g + "px", h.setSize(a.id, [f, g]), C.setSize && C.setSize(a.id, f, g)
                        },
                        va = function () {
                            for (var a in aa) {
                                var b = D.getGroup(a);
                                if (b) {
                                    var c = xa.getGroupDefinition(D.getNodeType(b.data));
                                    c.autoSize && ua(b, c)
                                }
                            }
                        };
                    C.autoSizeGroups = va, C.sizeGroupToFit = function (a) {
                        if (a) {
                            var b = xa.getGroupDefinition(D.getNodeType(a.data));
                            b.autoSize && ua(a, b)
                        }
                    };
                    var wa = function (b, c) {
                        return function () {
                            var d = Aa(b);
                            d.doNotFireConnectionEvent = !0, c && (d.geometry = c), D.isDebugEnabled() && console.log("Renderer", "adding edge with params", d);
                            var e = R.connect(d);
                            e.edge = b, fa[b.getId()] = e, ja(d.type, b, e), C.fire(l.edgeAdded, {
                                source: b.source,
                                target: b.target,
                                connection: e,
                                edge: b,
                                geometry: c
                            }), a.refreshLayoutOnEdgeConnect && C.refresh(!0);
                            var f = b.source.getNode ? b.source.getNode() : b.source,
                                g = Z[f.id] || aa[f.id],
                                h = b.target.getNode ? b.target.getNode() : b.target;
                            !1 !== (Z[h.id] || aa[h.id])._jtkVisible && !1 !== g._jtkVisible || t(b, !1)
                        }
                    };
                    m(l.edgeAdded, function (b) {
                        if (!Y && b.source !== C) {
                            var c = b.edge,
                                d = xa.getEdgeDefinition(D.getEdgeType(c.data || {}));
                            if (d && !0 === d.ignore) return;
                            var e = wa(c, b.geometry);
                        ...
                        if (!Y && a.source !== C) {
                            var b = a.edge,
                                c = fa[b.getId()];
                            c && (D.isDebugEnabled() && console.log("Renderer", "removing edge", b), ka(b), delete fa[b.getId()], null != c._jsPlumb && R.deleteConnection(c, {
                                fireEvent: !1
                            }))
                        }
                        ...
                        if (!Y && a.source !== C) {
                            var b = a.obj,
                                c = fa[b.getId()];
                            if (c) {
                                var d = xa.getEdgeDefinition(a.newType);
                                if (d && !0 === d.ignore) return;
                        ...
                        if (!Y) {
                            var b = a.edge,
                                c = fa[b.getId()],
                                d = Z[b.target.getFullId()] || aa[b.target.getFullId()];
                            c ? R.silently(function () {
                                null != d ? (D.isDebugEnabled() && console.log("target change", c), R.setTarget(c, d)) : (delete fa[b.getId()], R.detach({
                                    connection: c,
                                    forceDetach: !0,
                                    fireEvent: !1
                                }))
                            }) : null != d && D.isDebugEnabled() && e.log("Target for Edge " + b.getId() + " changed to Node " + d.id + "; we have no valid connection.")
                        }
                    }), m(l.edgeSource, function (a) {
                        if (!Y) {
                            var b = a.edge,
                                c = fa[b.getId()],
                                d = Z[b.source.getFullId()] || aa[b.source.getFullId()];
                            c ? R.silently(function () {
                                null != d ? R.setSource(c, d) : (delete fa[b.getId()], R.detach({
                                    connection: c,
                                    forceDetach: !0,
                                    fireEvent: !1
                                }))
                            }) : null != d && D.isDebugEnabled() && e.log("Source for Edge " + b.getId() + " changed to Node " + d.id + "; we have no valid connection.")
                        }
                    }), m("graphClearStart", function () {
                        R.reset(!0);
                        for (var a in aa) void 0 !== aa[a]._rotors && B.remove(aa[a]), aa[a].parentNode && aa[a].parentNode.removeChild(aa[a]);
                        for (var b in Z) void 0 !== Z[b]._rotors && B.remove(Z[b]), Z[b].parentNode && Z[b].parentNode.removeChild(Z[b]);
                        E && E.clear(), da.length = 0, ba.length = 0, fa = {}, Z = {}, aa = {}, $ = {}, ca = {}, _ = {}, Ga = {}, C.getZoom && R.setZoom(C.getZoom())
                    }), m(l.portAdded, function (a) {
                        var b = Z[a.node.id] || aa[a.node.id];
                        if (xa.getPortDefinition(D.getPortType(a.data)).isEndpoint) n(new La(a.data, b, a.port), a.node);
                        else {
                            var c = Da(a.port, a.data, a.node);
                            _[a.node.id + D.getGraph().getPortSeparator() + a.port.id] = c, Ma(R.getElement(c), a.node), C.fire(l.portAdded, {
                                node: a.node,
                                nodeEl: b,
                                port: a.port,
                                portEl: c
                        ...
                        R.recalculateOffsets(b), C.refresh(!0)
                    }), m(l.portRemoved, function (a) {
                        var b = Z[a.node.id] || aa[a.node.id],
                            c = a.node.id + "." + a.port.id,
                            d = _[c];
                        R.setSuspendEvents(!0), R.remove(d), R.setSuspendEvents(!1), delete _[c], C.fire(l.portRemoved, {
                            node: a.node,
                            port: a.port,
                            portEl: d,
                            nodeEl: b
                        ...
                        var b = fa[a.edge.getId()];
                        if (b) {
                            var c = Aa(a.edge);
                            b.setType(c.type, c.data)
                        }
                    }), m(l.portUpdated, function (a) {
                        var b = _[a.port.getFullId()];
                        b && (B.update(b, a.port.data), C.repaint(Z[a.node.id]))
                    }), m(l.nodeUpdated, function (a) {
                        var b = Z[a.node.getFullId()];
                        if (b) {
                            B.update(b, a.node.data), Ma(b, a.node);
                            var c = M(a.node);
                            if (null != c) {
                                var d = e.isArray(c) ? c : [c];
                                d.unshift(b), R.setPosse.apply(R, d)
                            } else R.removeFromAllPosses(b);
                            C.repaint(b)
                        }
                    })
                }
                ...
                var ya = [],
                    za = function (a) {
                        return null == a ? D : "string" == typeof a ? D.select(a, !0) : a.jtk ? D.select(a.jtk.port || a.jtk.node, !0) : a
                    };
                this.activateState = function (a, b) {
                    var c = xa.getState(a);
                    c && (b = za(b), c.activate(b, C, D), ya.push(c))
                }, this.deactivateState = function (a, b) {
                    var c = xa.getState(a);
                    c && (b = za(b), c.deactivate(b, C, D), e.removeWithFunction(ya, function (a) {
                        return a == c
                    }))
                }, this.resetState = function () {
                    for (var a = 0; a < ya.length; a++) ya[a].deactivate(D, C, D);
                    ya.length = 0
                };
                var Aa = function (a) {
                        var b = D.getEdgeType(a.data),
                            c = {
                                type: b,
                                connectionType: b,
                                data: a.data,
                            ...
                            f = function (b, d) {
                                if (a[b].getNode) {
                                    var f = a[b].getNode(),
                                        g = a[b].getFullId(),
                                        h = Ga[g] || _[g];
                                    c[b] = null != h ? h : _[g], null == c[b] && (c[b] = Z[D.getNodeId(f.data)]);
                                    var i = xa.getPortDefinition(a[b].getType());
                                    e(c, "anchors", "anchor", i, d), e(c, "endpoints", "endpoint", i, d)
                                } else {
                                    var j = D.getNodeId(a[b].data),
                                        h = 0 === d ? Ha[j] : Ia[j];
                                    c[b] = null == h ? Z[j] || aa[j] : h
                                }
                            };
                        return f("source", 0), f("target", 1), c
                    },
                    Ba = function (a, b, c, d, e, g, h, i) {
                        return function (j, k, l) {
                            ...
                            if (q) {
                                ...
                                o = q.templateRenderer ? q.templateRenderer(t, r, D, a, C) : K.render(t, r, D, a, C)
                            } else o = e(r, n);
                            o = R.getElement(o), o.setAttribute(i, n), f.addClass(o, h), o.jtk = o.jtk || {}, o.jtk[a] = j, o.jtk.node = l, g && G && Oa.makeDraggable && Oa.makeDraggable(o, q.dragOptions), H && Oa.makeDroppable && Oa.makeDroppable(o, q.dropOptions);
                            var u = function (a) {
                                R.on(o, a, function (b) {
                                    q.events[a]({
                                        node: l,
                            ...
                            if (q && q.events)
                                for (m in q.events) u(m);
                            return o
                        }
                    },
                    Ca = Ba("node", D.getNodeId, D.getNodeType, "getNodeDefinition", w, !0, j.NODE, h.NODE),
                    Da = Ba("port", D.getPortId, D.getPortType, "getPortDefinition", w, !1, j.PORT, h.PORT),
                    Ea = Ba("group", D.getNodeId, D.getNodeType, "getGroupDefinition", w, !1, j.GROUP, h.GROUP);
                this.initialize = function () {
                    var b, c, d, e, f;
                    if (D.setSuspendGraph(!0), R.setSuspendDrawing(!0), a.jsPlumbInstance) {
                        a.jsPlumbInstance.select().each(function (a) {
                            fa[a.edge.getId()] = a
                        }), c = a.jsPlumbInstance.getManagedElements();
                        for (var g in c) {
                            var h = c[g].el;
                            Z[h.jtk.node.id] = h, $[a.jsPlumbInstance.getId(h)] = h.jtk.node
                        }
                        Oa.doImport && Oa.doImport(Z, fa)
                    } else {
                        for (b = 0, d = D.getGroupCount(); b < d; b++) e = D.getGroupAt(b), ta(e);
                        for (b = 0, d = D.getNodeCount(); b < d; b++) c = D.getNodeAt(b), ra(c);
                        for (b = 0, d = D.getNodeCount(); b < d; b++)
                            if (c = D.getNodeAt(b), Z[c.id]) {
                                var i = D.getAllEdgesFor(c);
                                for (f = 0; f < i.length; f++)
                                    if (i[f].source == c || i[f].source.getNode && i[f].source.getNode() == c) {
                                        var j = xa.getEdgeDefinition(D.getNodeType(i[f].data));
                                        if (j && !0 === j.ignore) continue;
                                        var k = Aa(i[f]);
                                        k.doNotFireConnectionEvent = !0;
                                        var l = R.connect(k);
                                        null != l && (l.edge = i[f], fa[i[f].getId()] = l, ja(k.type, i[f], l))
                                    }
                            }
                    }
                    va(), this.relayout(), R.setSuspendDrawing(!1, !0), D.setSuspendGraph(!1)
                }, this.getContainer = function () {
                    return F
                    ...
                    if (null == a) return null;
                    var b = a.getFullId();
                    return "Port" === a.objectType ? _[b] : "Group" === a.objectType ? aa[b] : Z[b]
                    ...
                    var b = v(a),
                        c = null;
                    return b && b.obj && "Port" === b.obj.objectType && R.selectEndpoints({
                        element: b.el
                    }).each(function (a) {
                ...
                var Fa = function (a) {
                    ...
                    if (b.jsPlumbToolkit = D, b.adapter = C, !c.Layouts[b.type]) throw "no such layout [" + b.type + "]";
                    return b.locationFunction || (b.locationFunction = function (a) {
                        return [g.data(a.data, N), g.data(a.data, O)]
                    }), new c.Layouts[b.type](b)
                };
                this.adHocLayout = function (a) {
                    if (a) {
                        var b = E;
                        this.setLayout(a), E = b
                    }
                    ...
                    return null != E ? E.getMagnetizedElements() : []
                }, this.magnetize = function (a) {
                    null != E && E.magnetize(a)
                }, this.refresh = function (a) {
                    I || a && !J || (E ? E.layout(function () {
                        "undefined" != typeof window ? window.setTimeout(R.repaintEverything, 0) : R.repaintEverything()
                    }) : R.repaintEverything())
                }, this.setRefreshAutomatically = function (a) {
                    J = a
                }, this.relayout = function (a) {
                    I || (E ? E.relayout(a, function () {
                        R.repaintEverything(), this.fire("relayout", this.getBoundsInfo())
                    }.bind(this)) : R.repaintEverything())
                ...
                var Ga = {},
                    ...
                    Ja = function (a, b, c) {
                        var g = a.value("port-id"),
                            ...
                            i = a.value("scope") || R.getDefaultScope(),
                            j = D.getNodeType(b),
                            k = xa.getNodeDefinition(j),
                            l = xa.getPortDefinition(g, k),
                            m = xa.getPortDefinition(h, k),
                            n = e.merge(m, l),
                        ...
                        if (o.connectionType = r, o.portId = g, o.portType = h, o.scope = i, o.parameters = o.parameters || {}, o.parameters.portId = g, o.parameters.portType = h, o.parameters.edgeType = r, o.parameters.scope = i, o.parameters.nodeId = b.id, o.events = {}, n.events)
                            for (u in n.events) o.events[u] = p(n.events[u]);
                        if (n.interceptors)
                            for (u in n.interceptors) o[u] = q(n.interceptors[u]);
                        var x = a.value("anchor-x"),
                            y = a.value("anchor-y"),
                            z = a.value("orientation-x"),
                            A = a.value("orientation-y"),
                            B = a.value("offset-x"),
                            E = a.value("offset-y");
                        return null != x && null != y && (o.anchor = [parseFloat(x), parseFloat(y), parseInt(z || "0", 10), parseInt(A || "0", 10), parseFloat(B || "0"), parseFloat(E || "0")]), f.extend(o, c || {}), o.events.anchorChanged = function (a) {
                            C.fire("anchorChanged", {
                                portId: g,
                                nodeId: b.id,
                                portType: h,
                                node: b,
                    ...
                    Ma = function (a, b) {
                        var c, d, e = f.getSelector(a, i.PORT),
                            g = f.getSelector(a, i.SOURCE),
                            h = f.getSelector(a, i.TARGET);
                        for (c = 0; c < g.length; c++) d = new Ka(g[c]), p(d, b);
                        for (c = 0; c < h.length; c++) d = new Ka(h[c]), q(d, b);
                        for (c = 0; c < e.length; c++) d = new Ka(e[c]), n(d, b)
                    };
                this.setLayout(a.layout, !0), this.storePositionsInModel = function (a) {
                    ...
                    var b = a.leftAttribute || "left",
                        ...
                        d = E.getPositions();
                    for (var e in d) {
                        var f = D.getNode(e) || D.getGroup(e);
                    ...
                    var b = "string" == typeof a ? a : a.id,
                        ...
                        e = E.getPosition(b),
                        f = D[a.group ? "getGroup" : "getNode"](b);
                    return f && (g.data(f.data, c, e[0]), g.data(f.data, d, e[1])), e
                };
                var Na = function (a, b, c, d, e, f, g) {
                    return a = a || v(b), a && (E.setPosition(a.id, c, d), e || (R.setAbsolutePosition(a.el, [c, d], f, g), R.revalidate(a.el))), a
                };
                this.setPosition = function (a, b, c, d) {
                    return Na(null, a, b, c, d)
                }, this.animateToPosition = function (a, b, c, d) {
                    var e = v(a);
                    if (e) {
                        var f = E.getPosition(e.id);
                        Na(e, a, b, c, !1, [f[0], f[1]], d)
                    }
                    ...
                    if (null != a) {
                        var d = function (a, d) {
                                if (d && (d.style.display = b ? "block" : "none", d._jtkVisible = b, C.fire(l.nodeVisibility, {
                                        node: a,
                                        el: d,
                                        state: b
                                    }), !c))
                                    for (var e = D.getAllEdgesFor(a), f = 0; f < e.length; f++)
                                        if (b) {
                    ...
                    d.each(a, function (a) {
                        var c = v(a);
                        c.el && R.setPosse(c.el, b)
                    })
                }, this.removeFromPosse = function (a, b) {
                    d.each(a, function (a) {
                        var c = v(a);
                        c.el && R.removeFromPosse(c.el, b)
                    })
                }, this.removeFromAllPosses = function (a) {
                    d.each(a, function (a) {
                        var b = v(a);
                        b.el && R.removeFromAllPosses(b.el)
                    })
                }, this.setPosseState = function (a, b, c) {
                    d.each(a, function (a) {
                        var d = v(a);
                        d.el && R.setPosseState(d.el, b, c)
                    })
                }, this.destroy = function () {
                    for (var a, b = 0; b < na.length; b++) try {
                        a = na[b], D.unbind(a.event, a.fn)
                    } catch (b) {
                ...
                var Oa = {
                    ...
                    container: F,
                    containerId: S,
                    getConnectionsForEdges: ha,
                    getConnectionForEdge: ga,
                    getElement: function (a) {
                        return Z[a] || aa[a]
                    },
    ...
    function () {
        ...
        this.ZoomWidget = function (a) {
            ...
            var Ha = function (a, b, c) {
                ...
                Oa = this.pageLocation = function (a) {
            ...
            var Wa = function (a, b, c, d, e, f) {
                ...
                Ya = {
                    ...
                    move: function (a, b) {
                        var c, d, e;
                        if (ia = !1, !ga) {
                            if (ha) e = Oa(a), c = e[0] - j[0], d = e[1] - j[1], Sa(c, d, a);
                            else if (fa && E && null != j) {
            ...
            var fb = this.pan = function (a, b, c) {
            ...
            this.fixElement = function (b, c, d) {
                ...
                var g, h = this.getApparentCanvasLocation(),
                    i = a.offset(u),
                    j = u.scrollLeft,
                    k = u.scrollTop,
                    l = [],
    ...
    function () {
        ...
        c.Surface = function (a) {
            ...
            var n, o = d.getElement(a.container),
                ...
                q = !0 !== a.directRender && !(!1 === a.elementsDraggable),
                r = !0 !== a.directRender && !0 === a.elementsDroppable,
                s = a.dragOptions || {},
                t = a.dropOptions || {},
                u = a.stateHandle,
                ...
                D = new b.Widgets.Lasso({
                    ...
                    onSelect: function (a, b, c, d) {
                        ...
                        var f = [],
                            g = z.findIntersectingNodes(a, b, !c[0]);
                        ...
                        for (var h = 0; h < g.length; h++) null != B && !1 === B(e(g[h])) || (f.push(e(g[h])), m.jsPlumb.addToDragSelection && m.jsPlumb.addToDragSelection(g[h].el));
            ...
            l.bind(i.relayout, function (a) {
                ...
                if (b) {
                    var c = l.getJsPlumb().getGroup(a.group.id),
                        ...
                        e = l.getSize(b);
                    z.suspend(b), l.fire(i.groupMemberAdded, a), m.jsPlumb.addToGroup(a.group.id, b, !0);
                ...
                var b = m.nodeMap()[a.node.id];
                if (b) {
                    z.restore(b), l.fire(i.groupMemberRemoved, a), m.jsPlumb.removeFromGroup(a.group.id, b, !0);
                ...
                if (q) {
                    ...
                    null != b && m.jsPlumb.extend(j, b), j[n] = e.wrap(j[n], function () {
                        ...
                        for (var b = function (b) {
                                ...
                                j.magnetize && !c.node.group ? c.pos = l.getLayout().setMagnetizedPosition(c.node.id, c.pos[0], c.pos[1], !0) : l.getLayout().setPosition(c.node.id, c.pos[0], c.pos[1], !0), z.positionChanged(b[0]), !1 !== v && (l.storePositionInModel({
                                    id: c.node.id,
                                    leftAttribute: w,
                                    topAttribute: x
            ...
            this.zoomToSelection = function (a) {
                ...
                null != d && z.setSize(m.jsPlumb.getId(d), b, c)
            ...
            this.selectEdges = function (a) {
                ...
                if (b.el) {
                    ...
                    var c = m.jsPlumb.getSize(b.el),
                        d = b.obj.getFullId();
                    l.setSize(d, c[0], c[1]), l.getLayout().setSize(d, c), l.fire(i.objectRepainted, b)
                }
            ...
            var R = function (a) {
                ...
                var c, f = a.dataGenerator || function () {
                    ...
                    t = function (b, c, d) {
                        ...
                        if (a.drop && (e = !1 !== a.drop.apply(this, arguments)), e) {
                            ...
                            k(o.left, o.top, q), r ? m.toolkit.getGroupFactory()(p, q, function (c) {
                                ...
                                return null != n && (m.toolkit.addToGroup(d, n.group), l.setPosition(m.nodeMap()[d.id], o.left, o.top), g.getDragManager().updateOffsets(n.el)), a.onDrop && a.onDrop(d, b, o), d
                            }, b, d)
                        }
                    },
                    u = function () {
                    ...
                    v = function () {
                        try {
                            if (n && l.getJsPlumb().removeClass(n.el, "jtk-drag-hover"), "true" === arguments[0].el.getAttribute("jtk-group")) n = null;
                            else {
                    ...
                    w = d.dragEvents[h.start],
                    x = d.dragEvents[h.drag],
                    y = d.dragEvents[h.stop],
                    A = d.dragEvents[h.drop],
                    B = function () {},
                    C = a.nativeFilter || [],
                    D = a.allowNative,
                    E = {};
    ...
    function () {
        ...
        c.Miniview = function (a) {
            ...
            var M = function (a) {
                ...
                O = function (a, b) {
                    if (!a.node || !1 !== F(a.node)) {
                        ...
                        if (w && h.setAttribute("jtk-miniview-type", w(a.node)), h.relatedElement = a.el, h.jtk = a.node, t = p.getBoundsInfo(), h.setAttribute(i.jtkNodeId, a.node.id), h.setAttribute(i.relatedNodeId, a.el.getAttribute(g.id)), r.appendChild(h), A.add(h), m.nodeMap()[(a.node || a.group).id] = h, a.group) N(a.group, h);
                        else if (a.node.group) {
                            var j = m.nodeMap()[a.node.group.id];
                            j && (j.appendChild(h), A.suspend(a.el))
                        }
                        n.getLayout().map(a.node.id, h), k()
                    }
                };
            this.registerNode = function (a) {
                O(a, "Group" === a.node.objectType ? f.MINIVIEW_GROUP_ELEMENT : ""), M(a)
            };
            var P = this.setOffset;
            this.setOffset = function (a, b) {
                P.apply(this, arguments), A.positionChanged(a, [b.left, b.top])
            };
            var Q = this.setAbsolutePosition;
            this.setAbsolutePosition = function (a, b) {
                Q.call(this, a, b), A.positionChanged(a, b)
            ...
            var T = function (a) {
                    var b = a.node,
                        c = m.nodeMap()[b];
                    c && (A.remove(c), delete m.nodeMap()[b], m.jsPlumb.removeElement(c)), a.dontUpdatePanner || k()
                },
                U = function () {
                    var a = m.nodeMap();
                    for (var b in a) T({
            ...
            p.bind(h.pan, k), p.bind(h.zoom, k), p.bind(h.nodeMoveEnd, M), p.bind(h.nodeRemoved, T), p.bind(h.nodeAdded, O), p.bind(h.nodeRendered, O), p.bind(h.groupMoveEnd, M), p.bind(h.groupAdded, function (a) {
                O(a, f.MINIVIEW_GROUP_ELEMENT)
            }), p.bind(h.groupMoveEnd, M), p.bind(h.groupMemberAdded, function (a) {
            ...
            }), p.bind(h.relayout, k), p.bind(h.objectRepainted, S), p.bind(h.stateRestored, k), p.bind(h.nodeVisibility, V), a.bindToToolkit(h.graphClearStart, U);
            var W = function () {
                L(!0)
            };
            n.getLayout().bind(h.redraw, W), this.setHostLayout = function (a) {
                var b = n.getLayout();
                b && b.setHostLayout(a)
            ...
            G = {
                ...
                SELECT: function (a, b) {
                    for (var c = a.getAttribute("multiple"), d = 0; d < a.options.length; d++)
                        if (c) b.indexOf(a.options[d].value) > -1 && (a.options[d].selected = !0);
